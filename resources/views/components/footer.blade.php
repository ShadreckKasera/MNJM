   ...
   <footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
    <div class="flex flex-col md:flex-row">
      <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
        <h3 class="font-bold text-2xl">MNMJ</h3>
        <p class="text-gray-400">promote nursing and midwifery research</p>
      ...
      <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
        ...
        <p class="text-sm text-gray-400 mt-12">© 2024 MNMJ. <br class="hidden lg:block">All Rights Reserved.
        </p>
      </div>
    </div>
  </footer>
