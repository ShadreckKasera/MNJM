          ...
          <ul class="flex text-white">
            ...
            <li class="ml-6">
                <div class="flex items-center">
                    ...
                    <span class="ml-2">+26599000002</span>
                </div>
            </li>
            <li class="ml-6">
                <div class="flex items-center">
                    <input type="text" class="px-3 py-1 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500" placeholder="Search">
                </div>
            </li>
        </ul>
         ...
         <div class="hidden md:block w-full md:w-auto" id="menu">
             <nav
                 ...
                 <ul class="md:flex items-center">
                     <li>
                         <a class="py-2 px-4 inline-block md:text-white md:hidden lg:block font-semibold rounded-lg transition-colors duration-300 ease-in-out bg-grey text-white hover:bg-green-500 hover:text-white"
                     ...
                     <li class="ml-6">
                         <form action="{{ route('logout') }}" method="POST">
                             @csrf
                             <button type="submit"
                                 class="py-2 px-4 inline-block md:text-white md:hidden lg:block font-semibold rounded-lg transition-colors duration-300 ease-in-out bg-grey text-white hover:bg-green-500 hover:text-white">Logout</button>
                         </form>
                     </li>
